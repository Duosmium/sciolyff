      ...
      errors: [
        {
          context: {
            ...
            medals: 3,
            name: 'Menomonie Regional',
            'short name': 'Menomonie Regional',
      ...
      errors: [
        {
          ...
          message: 'places for event: Boomilever don\'t start at one',
          warning: false,
        },
      ],
      status: 'Invalid SciOlyFF!',
...
> Snapshot 1

    {
      errors: [
        {
          context: {
            name: 'Nonexistent Event Nonsense',
          },
          location: {
            column: 9,
            line: 15,
          ...
          message: 'non-canonical event: Nonexistent Event Nonsense',
          warning: true,
        },
        {
          context: {
            name: 'Crazy Carrot Footballers',
          },
          location: {
            column: 9,
            line: 16,
          ...
          message: 'non-canonical event: Crazy Carrot Footballers',
          warning: true,
        },
        {
          context: {
            number: 1,
            school: 'Nonexistent High School',
            state: 'AK',
          },
          location: {
            column: 11,
          ...
          message: 'non-canonical school Nonexistent High School',
          warning: true,
        },
        {
          context: {
          ...
          message: 'non-canonical school Hogwarts',
          warning: true,
        },
      ],
      status: 'Valid SciOlyFF! (with warnings)',
